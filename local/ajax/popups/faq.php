...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "IBLOCK_TYPE" => "forms",
        "IBLOCK_ID" => \Bitrix\Main\Config\Option::get('meven.info', 'iblock_form_faq'),
        "SUCCESS_MESSAGE" => "Мы получили Ваш вопрос. Мы постараемся ответить на Ваш вопрос в течении трех дней",
