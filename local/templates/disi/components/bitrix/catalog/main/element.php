...
$APPLICATION->SetPageProperty('shownews', 'N');
$APPLICATION->SetPageProperty('showseo', 'N');

$this->setFrameMode(true);
?>
</div>
<div class="section__overlay mb-32 mb-lg-80 pt-lg-48" id="product_content">
    <div class="container">
...
<?php
        ...
        <div class="carousel carousel--cards carousel--arrows-card mb-56 mb-xl-112">
...
$price = Content::getMinMaxPriceCatalog($iblock, ['SORT' => 'ALL', 'BRAND_ID' => false, 'SECTION_ID' => false, 'PRODUCT_ID' => $elementId])['MIN']['PRICE'];

$iPropValues = new \Bitrix\Iblock\InheritedProperty\ElementValues($iblock, $elementId);

$title = $iPropValues->getValues()['ELEMENT_META_TITLE'];
$desc = $iPropValues->getValues()['ELEMENT_META_DESCRIPTION'];

$title = str_replace('{_price_}', $price, $title);
$desc = str_replace('{_price_}', $price, $desc);
