...
else
{
        ...
        foreach ($order['PAYMENT'] as $payment)
        {
            ...
            <div class="py-16 border-bottom">
                <div class="row align-items-center">
                    <div class="col-auto">
                        <a class="link fw-600" href="<?=$order['ORDER']['URL_TO_DETAIL']?>"><?=Loc::getMessage('SPOL_TPL_NUMBER_SIGN')
                        .$order['ORDER']['ACCOUNT_NUMBER']?></a><span class="text-gray p-md ml-8">от <?=$order['ORDER']['DATE_INSERT_FORMATED']?></span>
                    ...
                    <div class="col-auto ml-auto text-right">
                        ...
                        <a class="btn btn--border btn--sm" href="/personal/orders/?COPY_ORDER=Y&ID=<?=$order['ORDER']['ID']?>">
    ...
    if ($arResult['COUNT'] > 0): ?>
        <a class="btn btn--border btn--sm btn--toggle-plus my-32" href="/personal/orders/">Просмотреть все заказы (<?=$arResult['COUNT']?>)</a>
    <? endif; ?>
    <?php
