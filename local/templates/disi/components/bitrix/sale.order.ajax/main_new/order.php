        ...
        <div class="basket basket--order mb-40 mb-lg-80">
            <div class="basket__main mb-32 mb-lg-120">
                ...
                <form class="form" id="soa-form" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <input type="hidden" name="RECENT_DELIVERY_VALUE" value="6">
                    ...
                    <div class="d-lg-flex mb-32 mb-lg-40">
                        <ul class="nav nav-pills">
                            <input type="hidden" class="js-refresh-elem pt_id" name="PERSON_TYPE" value="<?=$arResult["USER_VALS"]["PERSON_TYPE_ID"]?>">
                            <?foreach($arResult["PERSON_TYPE"] as $arPT){?>

                            <li class="nav-item pt_tabs">
								<a class="nav-link<?if($arResult["USER_VALS"]["PERSON_TYPE_ID"]>0 && $arResult["USER_VALS"]["PERSON_TYPE_ID"]==$arPT["ID"]){?> active<?}?>" href="#pttab-<?=$arPT["ID"]?>" data-ptid="<?=$arPT["ID"]?>" data-toggle="tab"><?=$arPT["NAME"]?></a>
                            </li>
                            <?}?>
                        </ul>
                    </div>
                    ...
                    <div class="delivery_block">
                        <div class="d-lg-flex mb-32 mb-lg-40 delivery_tabs">
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#deliverytab-1"  data-toggle="tab">Нужна доставка</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#deliverytab-2" data-toggle="tab">Самовывоз</a>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content">
                        <div id="deliverytab-1" class="form__block form__block--delivery tab-pane fade show active" data-delivery="<?=$needDeliveryServices?>"></div>
                        <div id="deliverytab-2" class="form__block form__block--delivery tab-pane fade" data-delivery="<?=$selfDeliveryServices?>"></div>
                    </div>
            ...
            <div class="basket__aside basket__aside--sticky">
                <div class="basket__total-block mb-8">
                    ...
                    <a class="btn btn--red w-100 px-0" onclick="getAllOrderElements()" id="soa-submit-button" href="#">Оформить заказ</a>
                </div>
