...
<div class="position-relative" style="max-width: 600px;">
	<input type="text" class="search__input" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" />
	<button class="search__btn" type="submit">
        <svg class="icon icon-search">
            <use xlink:href="/local/templates/disi/assets/icons/symbol-defs.svg#icon-search"></use>
        </svg>
    </button>
